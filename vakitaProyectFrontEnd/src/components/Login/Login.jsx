...
function Login() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string()
        .min(4, "Debe contener 4 digitos o más")
        .max(50)
    ...
    <ContainerGeneral>
      <GeneralFormContainer>
        <FormContainer onSubmit={formik.handleSubmit}>
          ...
          <ContainerInput>
            <Label htmlFor="Contraseña" className="input-contraseña">
          ...
          <Questions>
            <h5 className="preguntas">
              ...
              <ButtonRegister type="button" onClick={handlePasswordChange}>
                Click Aquí
              </ButtonRegister>{" "}
            </h5>
            <h5 className="preguntas">
              ...
              <Link to="/register">
                {" "}
                <ButtonRegister type="button">Creala aquí</ButtonRegister>
              </Link>{" "}
            </h5>
          </Questions>
        </FormContainer>
